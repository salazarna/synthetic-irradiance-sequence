...
def stochastic(dictionary:dict, year:int, month:int, sky_condition:str, runs:int) -> dict:
    '''
    stochastic function generates synthetic irradiance data points according
    to the statistical analysis generated by `analysis` function.
    '''
    # Catching exception
...
def bootstrap(dictionary:dict, year:int, month:int, sky_condition:str, runs:int) -> dict:
    '''
    bootstrap function generates synthetic irradiance data points according
    to the real data by `analysis` function.
    '''
    # Catching exception
    if sky_condition not in ['sc1', 'sc2', 'sc3', 'sc4', 'sc5']:
        raise ValueError(f"An invalid sky condition ({sky_condition}) was selected. Select one of ['sc1', 'sc2', 'sc3', 'sc4', 'sc5'].")
